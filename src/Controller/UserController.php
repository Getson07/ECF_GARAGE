...
class UserController extends AbstractController
{
    ...
    public function new(Request $request, UserRepository $userRepo, UserPasswordHasherInterface $passwordHasher): Response
    {
        $user = new User();
    ...
    public function delete(Request $request, User $user, UserRepository $userRepo): Response
    {
