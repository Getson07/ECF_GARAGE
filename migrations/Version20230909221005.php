 ...
 */
final class Version20230909221005 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE car (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', poster_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', model_id INT NOT NULL, name VARCHAR(100) NOT NULL, images LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', price INT NOT NULL, fiscal_power VARCHAR(20) DEFAULT NULL, engine_power VARCHAR(20) NOT NULL, euro_standard VARCHAR(50) DEFAULT NULL, crit_air VARCHAR(10) DEFAULT NULL, combined_consumption VARCHAR(100) DEFAULT NULL, co2_emission VARCHAR(20) DEFAULT NULL, posted_at DATETIME NOT NULL, INDEX IDX_773DE69D5BB66C05 (poster_id), INDEX IDX_773DE69D7975B7E7 (model_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE car_caracteristic (id INT AUTO_INCREMENT NOT NULL, related_car_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', year_of_launch DATE NOT NULL, origin VARCHAR(50) DEFAULT NULL, technichal_control VARCHAR(100) NOT NULL, first_hand TINYINT(1) NOT NULL, energy VARCHAR(20) NOT NULL, gearbox VARCHAR(100) NOT NULL, color VARCHAR(20) NOT NULL, number_of_doors SMALLINT NOT NULL, number_of_seats SMALLINT NOT NULL, length VARCHAR(255) DEFAULT NULL, trunk_volume VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_351D30B16F0A8E39 (related_car_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE client (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', firstname VARCHAR(20) NOT NULL, lastname VARCHAR(20) NOT NULL, email VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, client_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', user_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', message LONGTEXT NOT NULL, rate SMALLINT DEFAULT NULL, INDEX IDX_9474526C19EB6921 (client_id), INDEX IDX_9474526CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE contact (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', client_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', sender_firstname VARCHAR(20) NOT NULL, sender_lastname VARCHAR(20) NOT NULL, sender_email VARCHAR(100) NOT NULL, subject VARCHAR(255) NOT NULL, message LONGTEXT NOT NULL, INDEX IDX_4C62E63819EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE equipment_options (id INT AUTO_INCREMENT NOT NULL, related_car_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', exterior_and_chassis LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', interior LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', security LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', security_lock VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_A64E35686F0A8E39 (related_car_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE opening_hours (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', scheduler_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', day_of_week VARCHAR(20) NOT NULL, opening_time TIME NOT NULL, closing_time TIME NOT NULL, start_break_time TIME NOT NULL, end_of_break TIME NOT NULL, INDEX IDX_2640C10BA9D0F7D9 (scheduler_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE service (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', poster_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', title VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_E19D9AD25BB66C05 (poster_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, firstname VARCHAR(20) NOT NULL, lastname VARCHAR(20) NOT NULL, gender VARCHAR(10) NOT NULL, date_of_birth DATE NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
